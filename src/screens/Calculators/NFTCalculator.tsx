...
const NFTCalculator: React.FC = () => {
  return (
    <View style={styles.container}>
      <Header />
      <ScrollView style={styles.content}>
        <Text style={styles.title}>NFT Zakat Calculator</Text>
        <Text style={styles.subtitle}>Coming soon - NFT calculator form will appear here</Text>
      </ScrollView>
    </View>
  );
};
