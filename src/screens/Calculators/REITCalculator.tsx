...
const REITCalculator: React.FC = () => {
  return (
    <View style={styles.container}>
      <Header />
      <ScrollView style={styles.content}>
        <Text style={styles.title}>REIT Zakat Calculator</Text>
        <Text style={styles.subtitle}>Coming soon - REIT calculator form will appear here</Text>
      </ScrollView>
    </View>
  );
};
