...
const CommodityCalculator: React.FC = () => {
  return (
    <View style={styles.container}>
      <Header />
      <ScrollView style={styles.content}>
        <Text style={styles.title}>Commodity Zakat Calculator</Text>
        <Text style={styles.subtitle}>Coming soon - Commodity calculator form will appear here</Text>
      </ScrollView>
    </View>
  );
};
