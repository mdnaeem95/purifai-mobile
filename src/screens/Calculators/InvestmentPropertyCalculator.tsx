  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <Text style={styles.title}>InvestmentProperty Zakat Calculator</Text>
        <Text style={styles.subtitle}>Coming soon - InvestmentProperty calculator form will appear here</Text>
      </ScrollView>
    </View>
  );
};
