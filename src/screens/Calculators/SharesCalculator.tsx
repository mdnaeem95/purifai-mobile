...
const SharesCalculator: React.FC = () => {
  return (
    <View style={styles.container}>
      <Header />
      <ScrollView style={styles.content}>
        <Text style={styles.title}>Shares Zakat Calculator</Text>
        <Text style={styles.subtitle}>Coming soon - Shares calculator form will appear here</Text>
      </ScrollView>
    </View>
  );
};
